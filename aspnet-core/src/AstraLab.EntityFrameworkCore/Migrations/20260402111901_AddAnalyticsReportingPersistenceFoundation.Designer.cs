...
namespace AstraLab.Migrations
{
    ...
    [Migration("20260402111901_AddAnalyticsReportingPersistenceFoundation")]
    partial class AddAnalyticsReportingPersistenceFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.AI.AIConversation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "DatasetId", "OwnerUserId", "LastInteractionTime");
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.AI.AIResponse", b =>
                {
                    ...
                    b.Property<long?>("DatasetTransformationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DatasetTransformationId");

                    b.HasIndex("DatasetVersionId");

                    b.HasIndex("MLExperimentId");

                    b.HasIndex("AIConversationId", "CreationTime");

                    b.HasIndex("TenantId", "DatasetVersionId", "ResponseType", "CreationTime");
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.Datasets.DatasetColumnProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("InferredDataType")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("DatasetProfileId", "DatasetColumnId")
                        .IsUnique();

                    b.HasIndex("TenantId", "DatasetProfileId");

                    b.ToTable("DatasetColumnProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.Datasets.DatasetProfile", b =>
                {
                    ...
                    b.Property<decimal>("DataHealthScore")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<long>("DuplicateRowCount")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AstraLab.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AstraLab.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.AI.AIResponse", b =>
                {
                    b.HasOne("AstraLab.Core.Domains.AI.AIConversation", "AIConversation")
                        .WithMany("Responses")
                        .HasForeignKey("AIConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AstraLab.Core.Domains.Datasets.DatasetTransformation", "DatasetTransformation")
                        .WithMany("AIResponses")
                        .HasForeignKey("DatasetTransformationId")
                    ...
                    b.Navigation("DatasetTransformation");
            ...
            modelBuilder.Entity("AstraLab.Core.Domains.Datasets.DatasetProfile", b =>
                {
                    b.HasOne("AstraLab.Core.Domains.Datasets.DatasetVersion", "DatasetVersion")
                        .WithOne("Profile")
                        .HasForeignKey("AstraLab.Core.Domains.Datasets.DatasetProfile", "DatasetVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
