...
{
    /// <summary>
    /// Stores immutable dataset version files and returns logical storage references.
    /// </summary>
    public interface IRawDatasetStorage
    {
        /// <summary>
        /// Stores a dataset version file in immutable form.
        /// </summary>
        Task<StoredRawDatasetFileResult> StoreAsync(StoreRawDatasetFileRequest request);

        /// <summary>
        /// Opens a previously stored dataset version file for reading.
        /// </summary>
        Task<Stream> OpenReadAsync(OpenReadRawDatasetFileRequest request);

        /// <summary>
        /// Deletes a previously stored dataset version file by logical reference.
        /// </summary>
